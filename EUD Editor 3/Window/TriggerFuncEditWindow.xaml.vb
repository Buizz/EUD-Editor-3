Public Class TriggerFuncEditWindow
    ...
    Private Sub Window_Loaded(sender As Object, e As RoutedEventArgs)
        If Arg.CodeBlock IsNot Nothing Then
            MainCtrl.OpenEdit(TriggerCodeEditControl.OpenType.Func, TBlock:=Arg.CodeBlock.DeepCopy)
        Else
            MainCtrl.OpenEdit(TriggerCodeEditControl.OpenType.Func)
        End If
    End Sub


    Public Sub New(_Arg As ArgValue)
