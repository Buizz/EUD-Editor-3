function SetCompletedUnitCount(Unit, Player, Modifier, Amount) --일반/TrgUnit,TrgPlayer,TrgModifier,Number/[Player]의 [Unit]의 완료된 유닛보유수를 [Amount]만큼 [Modifier]합니다.
...
function GetCompletedUnitCount(Unit, Player) --일반/TrgUnit,TrgPlayer/[Player]의 [Unit]의 완료된 유닛보유수를 반환합니다.
	Player = ParsePlayer(Player)
    Unit = ParseUnit(Unit)
    OffsetEPD = CompletedUnitCountEPD(Unit, Player)
