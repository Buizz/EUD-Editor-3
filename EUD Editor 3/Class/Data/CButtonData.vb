...
Public Class CButtonSet
    ...
    Private DefaultAddress As UInteger
    ...
    Public Sub New(_DefaultAddress As UInteger, tObjectID As Integer)
        ObjectID = tObjectID
...
Public Class CButtonData
    ...
    Public Function GetBtnText() As String
        Return _pos & "," & _icon & "," & _con & "," & _act & "," & _conval & "," & _conval & "," & _actval & "," & _enaStr & "," & _disStr
    End Function
