...
Partial Public Class BuildData
    ...
    Public Function GetMSQCLoaderEps() As String
        ...
        sb.AppendLine("		//=======================오류전송=======================")
        sb.AppendLine("		if(IsUserCP()){")
        sb.AppendLine("			const tinedx = (l_loadindex + l_datablockindex * 50) * 6;")
        ...
        sb.AppendLine("			")
        sb.AppendLine("			")
        sb.AppendLine("			s.printf(""\x07 l_errorlist {}"", l_errorlist[l_errorindex - 1]);")
        ...
        sb.AppendLine("		}")
        sb.AppendLine("		")
        sb.AppendLine("		s.printf(""\x07 lasterrorindex {}, lastreceiveerror {}"",lasterrorindex, lastreceiveerror);")
        sb.AppendLine("		if(lasterrorindex == lastreceiveerror){")
        sb.AppendLine("			loadstart[cp] = 2;")
        sb.AppendLine("			")
